...
class SingleFamilyHome(Dwelling):
    ...
    def set_yard_size(self, yard_self):
        self.__yard_size = yard_self

    def get_garage_type(self):
        return self.__garage_type

    def get_yard_self(self):
...
def main():
    ...
    home = SingleFamilyHome("6", '1200', '1', "single ", ".25 acres")
    ...
    print("Number of rooms: " + home.get_number_of_rooms() + "\nSquare feet: " + home.get_square_feet() +
          "\nNumber of floors: " + home.get_floors() + "\nGarage type: " + home.get_garage_type() +
          "\nYard size: ")
