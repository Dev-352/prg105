...
class MilesPerGallonCalculator:
    def __init__(self):
        ...
        self.title_label = tkinter.Label(self.title_frame, text="Miles Per Gallon Calculator")
        ...
        self.gallon_label = tkinter.Label(self.gallon_frame, wraplength=300, width=50,
                                          text="Please enter the number of gallons can can hold on a full tank:"
                                          )
        ...
        self.gallon_label2 = tkinter.Label(self.gallon_frame, text="gallon(s)", width=7, justify="left")
        ...
        self.miles_label = tkinter.Label(self.miles_frame, wraplength=300, width=50,
                                         text="Please enter the number of how miles the car can be driven on a full "
                                              "tank:")
        ...
        self.miles_label2 = tkinter.Label(self.miles_frame, text="mile(s)",  width=7, justify="left")
        ...
        self.calculate_button = tkinter.Button(self.button_frame, text="Calculate Mileage",
                                               command=self.calculate_mileage)
        # self.quit = tkinter.Button(self.button_frame, text="Quit", command=self.main_window.destory)
    ...
    def calculate_mileage(self):
        try:
            ...
            self.results_label_val.set("Mileage is: {:.2f} MPG".format(mileage))
        except ValueError:
